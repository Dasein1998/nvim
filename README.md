# Config fork from Neovim-from-scratch
This config is generated from LunarVim/Neovim-from-scratch. And I replace the plugins manager from packer to lazy.nvim.
